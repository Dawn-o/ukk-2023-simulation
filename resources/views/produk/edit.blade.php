    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="bg-white rounded-lg shadow-lg">
            <div class="px-4 py-5 sm:px-6 border-b border-gray-200 bg-gray-50">
                <h3 class="text-lg leading-6 font-medium text-gray-900">Edit Data Produk</h3>
                <p class="mt-1 text-sm text-gray-600">Silakan edit form dibawah ini dengan benar.</p>
            </div>

            <div class="px-4 py-5 sm:p-6">
                <form action="{{ route('produk.update', [$produk->id, $toko_id]) }}" method="POST" autocomplete="off">
                    @csrf
                    @method('PUT')
                    <div class="space-y-6">
                        <div class="relative">
                    ...
                    <div class="mt-8 flex items-center justify-end space-x-4">
                        <a href="{{ route('toko.show', $produk->id_toko) }}" 
